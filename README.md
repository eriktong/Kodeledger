...
![Pages Deploy](https://github.com/eriktong/Kodeledger/actions/workflows/pages.yml/badge.svg) ![Last commit](https://img.shields.io/github/last-commit/eriktong/Kodeledger) ![License](https://img.shields.io/badge/license-MIT-informational)
...
2. For CRA, ensure `"homepage": "https://eriktong.github.io/Kodeledger/"` exists in `package.json`.
3. For Vite, ensure `base: "/Kodeledger/"` in `vite.config.*`.
